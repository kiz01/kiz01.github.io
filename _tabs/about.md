...
I prefer hands-on labs, clear notes, and understanding the “why” behind each tool or technique.  
My goal is steady growth across SOC, cloud, and malware analysis — not rushing through checklists.

This site is where I publish:
- Lab walkthroughs  
- Notes from courses and experiments  
- Small write-ups on what I’m learning  

---

## What's Next

- Strengthening AWS + Linux fundamentals  
- Building cloud-focused detection use cases  
- Advancing my reverse engineering skills  
- Creating more structured, high-quality write-ups on Wazuh and cloud security  

---

## Connect

- **GitHub:** https://github.com/kiz01
- **LinkedIn:** https://linkedin.com/in/kiz01
